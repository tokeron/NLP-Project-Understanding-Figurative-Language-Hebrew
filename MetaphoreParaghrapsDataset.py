...
class MetaphoreParaghrapsDataset(datasets.GeneratorBasedBuilder):
    """This is a dataset of songs in hebrew with labels for metaphors"""
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "train_paragraphs.json"),
                    "split": "train",
                },
            ),
            datasets.SplitGenerator(
                ...
                # These kwargs will be passed to _generate_examples
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "test_paragraphs.json"),
                    "split": "test"
                },
            ),
            datasets.SplitGenerator(
                ...
                # These kwargs will be passed to _generate_examples
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "validation_paragraphs.json"),
                    "split": "validation",
                },
            ),
        ]
