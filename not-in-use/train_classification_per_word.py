...
def train_classification():
    ...
    gradient_accumulation_steps = training_args.model_args.gradient_accumulation_steps
    ...
    experiment_name = "{}_word{}{}{}bs_{}_gas_{}_ep_{}_wl_{}_lr_{}_v_{}_lc_{}".format(
    ...
    # if not os.path.exists(path_words_statistics):
    ...
    model = AlephBertPerWord(layers_for_cls=layers_for_classification, only_intermid_rep=only_intermid_rep)
    ...
    torch.save(model.state_dict(), checkpoints_dir + "/" + experiment_name)
