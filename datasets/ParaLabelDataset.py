...
class MetaphorParaDataset(datasets.GeneratorBasedBuilder):
    """This is a dataset of songs in hebrew with labels for metaphors"""
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(data_dir, 'train', "train_para_word_label.json"),
                    "split": "train",
                },
            ),
            datasets.SplitGenerator(
                ...
                # These kwargs will be passed to _generate_examples
                gen_kwargs={
                    "filepath": os.path.join(data_dir, 'test', "test_para_word_label.json"),
                    "split": "test"
                },
            ),
            datasets.SplitGenerator(
                ...
                # These kwargs will be passed to _generate_examples
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "train", "validation_para_word_label.json"),
                    "split": "validation",
                },
            ),
        ]
