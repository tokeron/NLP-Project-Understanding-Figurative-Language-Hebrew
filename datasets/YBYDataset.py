...
class YBYDataset(datasets.GeneratorBasedBuilder):
    """This is a dataset of songs in hebrew with labels for metaphors"""
    VERSION = datasets.Version("1.2.5")
    ...
    def _split_generators(self, dl_manager):
        ...
        data_for_test = "more_tests.json"
        filepath = os.path.join(data_dir, data_for_test)
