...
def prepare_data_BY(output):
    ...
    fl_data_path = '/home/tok/figurative-language/figurative-language-data'
    fl_data_paths = {'piyyut':
                         '{}/train/piyyut_texts.csv'.format(fl_data_path),
                     'pinechas':
                         '{}/train/pinechas_hacohen_texts.csv'.format(fl_data_path),
                     'yose':
                         '{}/test/yose_ben_yose_texts.csv'.format(fl_data_path)
                     }

    if generate_data_from_git:
        main_path = '/home/tok/figurative-language/public_domain_dump'
        data_path = 'txt_stripped'
        pseudocatalogue = 'pseudocatalogue.csv'
        path_to_data = os.path.join(main_path, data_path)
        path_to_pseudocatalogue = os.path.join(main_path, pseudocatalogue)
        ...
        if not os.path.exists('/home/tok/figurative-language/DataExploration/plots'):
            os.makedirs('/home/tok/figurative-language/DataExploration/plots')
        plt.savefig('/home/tok/figurative-language/DataExploration/plots/words_in_genres.png')
        # plt.show()
...
if __name__ == '__main__':
    ...
    output_data_folder = '/home/tok/figurative-language/data/mlm-data'
