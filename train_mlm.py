...
def train_mlm(args):
    ...
    model_name = 'xml_' if 'xlm' in model_checkpoint else 'bert_'
    ...
    wandb.init(project="mlm_training", entity="tokeron", name=experiment_name, config=wandb_config)
    ...
    path_to_catalog = os.path.join(main_path, pseudocatalogue)
